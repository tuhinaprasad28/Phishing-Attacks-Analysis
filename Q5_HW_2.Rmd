...
```{r}
######################Using Cross Validation Technique to determine Accuracy of Decision Tree#########################
...
#This cross validation suggest that we have received ~ 11% error from 10 fold cross validation which is in tune with previous accuracy obtained with decision tree.
...
legend(0.8, 0.3, c(minauct_g_dt, maxauct_g_dt, "\n"), border = "white", cex = 0.6, box.col = "blue")
#######################################################################################################################
```
...
minauc_r_dt = min(round(r_dt, digits = 2))
maxauc_r_dt = max(round(r_dt, digits = 2))
minauct_r_dt = paste(c("min(Response) = "), minauc_r_dt, sep = "")
maxauct_r_dt = paste(c("max(Respose) = "), maxauc_r_dt, sep = "")
legend(0.6, 0.4, c(minauct_r_dt, maxauct_r_dt, "\n"), border = "white", cex = 0.6, box.col = "blue")
###########################################################################################################
```
...
legend(0.8, 0.3, c(minauct_g_nb, maxauct_g_nb, "\n"), border = "white", cex = 0.6, box.col = "blue")
####################################################################################################################
```

```{r}
################Response Chart for Naive Bayes#######################################################################
...
r_nb <-unlist(slot(Response_Chart_nb,"y.values"))

minauc_r_nb = min(round(r_nb, digits = 2))
maxauc_r_nb = max(round(r_nb, digits = 2))
minauct_r_nb = paste(c("min(Response) = "), minauc_r_nb, sep = "")
maxauct_r_nb = paste(c("max(Respose) = "), maxauc_r_nb, sep = "")
legend(0.2, 0.6, c(minauct_r_nb, maxauct_r_nb, "\n"), border = "white", cex = 0.6, box.col = "blue")
################################################################################################################
```
...
legend(0.2, 0.6, c(minauct_g_rf, maxauct_g_rf, "\n"), border = "white", cex = 0.6, box.col = "blue")
###########################################################################################################################
```

```{r}
################Response Chart for Random Forest #######################################################################
...
r_rf <-unlist(slot(Response_Chart_rf,"y.values"))

minauc_r_rf = min(round(r_rf, digits = 2))
maxauc_r_rf = max(round(r_rf, digits = 2))
minauct_r_rf = paste(c("min(Response) = "), minauc_r_rf, sep = "")
maxauct_r_rf = paste(c("max(Respose) = "), maxauc_r_rf, sep = "")
legend(0.6, 0.4, c(minauct_r_rf, maxauct_r_rf, "\n"), border = "white", cex = 0.6, box.col = "blue")
#################################################################################################################
```
...
TPR- True Positive Rate(Ratio of No. of samples as correctly identified as positive to the total no.of actually positive samples. We want most of our websites to be identified correctly, hence we need high TPR rate.)
For showing this comparison we have used gain chart for all the three models.
...
abline(a=0, b=1)
legend(0.6, 0.2, c(minauct_dt, maxauct_dt, "\n"), border = "white", cex = 0.5, box.col = "blue")
...
abline(a=0, b=1)
legend(0.6, 0.2, c(minauct_nb, maxauct_nb, "\n"), border = "white", cex = 0.5, box.col = "blue")
#################################################################################################################
```
...
abline(a=0, b=1)
legend(0.6, 0.1, c(minauct_g_rf, maxauct_g_rf, "\n"), border = "white", cex = 0.5, box.col = "blue")
...
abline(a=0, b=1)
legend(0.6, 0.1, c(minauct_g_dt, maxauct_g_dt, "\n"), border = "white", cex = 0.5, box.col = "blue")
...
abline(a=0, b=1)
legend(0.6, 0.1, c(minauct_g_nb, maxauct_g_nb, "\n"), border = "white", cex = 0.5, box.col = "blue")
```
...
abline(a=0, b=1)
legend(0.6, 0.1, c(minauct_prr_nb, maxauct_prr_nb, "\n"), border = "white", cex = 0.5, box.col = "blue")
```
...
After the conducting the 10 fold Cross Validation in each of the models(Decision Tree, Naive Bayes and Random Forest), we found that Random Forest has the highest accuracy.To tackle Phishing websites, we require a measure of both True Positive Rate and False Positive Rate. We have shown accuracy comparison between our models through the ROC curve, the Gain Chart, the Response Chart and the Precision Recall Curve. But we choose the ROC curve as our final evaluation measure as it has both True Positive Rate and False Positive Rate which is utmost important for identifying the phishing and the legitimate websites. We plotted the ROC curve for all the three models(Decision Tree, Naive Bayes and Random Forest) and we got the below AUC accuracy measure:
